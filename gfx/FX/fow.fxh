PixelShader = 
{
	...
	static const float HEIGHT_FOG_END = 40.0;
	static const float HEIGHT_FOG_START = 12.0;
	static const float HEIGHT_FOG_POW = 3.5;
	static const float HEIGHT_FOG_MAX = 1.0;
	
	static const float FOW_TRANSPARENCY_MIN = 0.5;
	static const float FOW_TRANSPARENCY_MAX = 0.75;
	
	static const float FOW_COLOR_MIN = 0.1;
	static const float FOW_COLOR_MAX = 0.1;
	
	static const float FOW_NOISE_TILING = 0.01;
	static const float FOW_NOISE_SPEED = 0.015;
	
	static const float3 BRIGHT_FOW_COLOR = float3(1.00, 1.10, 1.00);
	static const float3 DARK_FOW_COLOR = float3(0.01, 0.10, 0.01);
	
	static const float INTEL_CUTOFF = 0.25;
